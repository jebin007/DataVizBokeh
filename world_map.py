...
#method to get latitudes and longitudes of all countries
...
#populate country_coords with latitudes and longitudes
...
#this merges the data from the csv by adding a new column of latitudes and longitudes
...
#convert world_map_with_data dataframe to ColumnDataSource.
map_data = ColumnDataSource(world_map_with_data)

world_map_plot = figure(plot_width=900, plot_height=600, title='World Map', tools=TOOLS,
                        x_range=(-180, 180),
                        y_range=(-90, 90)
                        )

#lats and longs here are x and y coordinates
...
#We merged country coordinates data with the dataframe from csv files to display relevant hover data at each coordinates.
